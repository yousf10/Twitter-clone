  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedFontSize: 16,
        selectedIconTheme:
            IconThemeData(color: Colors.black, opacity: 1.0, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Colors.black, opacity: 1.0, size: 24),
        ...
        items: [
          ...
          BottomNavigationBarItem(
              ...
              icon: ImageIcon(
                  ...
                  color: Colors.black),
              activeIcon: Image.asset(
                "assets/Icon/navicon/search2.png",
                color: Colors.black,
                height: 69,
                width: 69,
              ),
          ...
          BottomNavigationBarItem(
              ...
              icon: ImageIcon(
                  ...
                  color: Colors.black),
              activeIcon: Image.asset(
                "assets/Icon/navicon/notfication2.png",
                color: Colors.black,
                height: 63,
                width: 63,
              ),
          ...
          BottomNavigationBarItem(
              ...
              icon: ImageIcon(
                  ...
                  color: Colors.black),
              activeIcon: Image.asset(
                "assets/Icon/navicon/message2.png",
                color: Colors.black,
                height: 63,
                width: 63,
              ),
